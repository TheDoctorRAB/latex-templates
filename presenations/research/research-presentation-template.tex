...
\setbeamertemplate{caption}[numbered] %numbers figures and tables
...
\usepackage{graphicx}
\usepackage{pythonhighlight,verbatim}
...
%\usepackage[stable,hang,flushmargin]{footmisc} %footnotes in section titles and no indent; standard.bst; comment out on presentations
...
\setlength{\bibsep}{5pt} %sets space between references
...
\captionsetup[figure]{justification=centering,skip=7pt,labelformat={default},labelsep=period,name={Figure}} %sets space above caption, 'figure' format
...
\begin{frame}[plain]{} %subtitle slide will not have any footers or title

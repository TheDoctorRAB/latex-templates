...
%\lhead{\scriptsize }
%\chead{\scriptsize }
\lfoot{\scriptsize\textit{Name -- \acs{phd} White Paper Project Proposal}\\\today}
\rfoot{\thepage}
%%%%%
...
{\centering 
    \textbf{Title\\
    \acs{phd} White Paper Project Proposal\\
    }
    Student Name\\
    Advisor Name\\
    \acl{ui} $\sq$ \acl{iff}\\
...
\part*{Contribution to Advancing State of the Art}
This project will advance the state-of-the-art in nuclear fuel cycle analysis by --
\begin{enumerate*}[series=outerlist,topsep=0pt,itemsep=-0.5ex,partopsep=1ex,parsep=1ex,label=(\arabic*),leftmargin=*]
    \item ; 
    \item ;
    \item .
\end{enumerate*}

...
\setlength{\bibsep}{3pt} %sets space between references
...
\section*{Summary of the Proposed Project} 
\subsection*{Proposal}
...
\begin{enumerate}[topsep=0pt,itemsep=-0.5ex,partopsep=1ex,parsep=1ex,label=\textbf{Workscope \arabic* -},align=left,leftmargin=0.5in]
    \item\textbf{X.} (\textit{Lead - ; Support - , })
        \begin{enumerate}[topsep=3pt,itemsep=1ex,partopsep=1ex,parsep=-1ex,label=\textit{Task \Roman*.},align=left,leftmargin=0.25in]
            \item\textit{x.}
            \item\textit{x.}
        \end{enumerate}
    \item\textbf{X.} (\textit{Lead - ; Support - , })
        \begin{enumerate}[resume,topsep=3pt,itemsep=1ex,partopsep=1ex,parsep=-1ex,label=\textit{Task \Roman*.},align=left,leftmargin=0.25in]
            \item\textit{x.}
            \item\textit{x.}
        \end{enumerate}
\end{enumerate}
...
\subsection*{Workscope 1 - Title}
\begin{enumerate}[topsep=0pt,itemsep=0ex,partopsep=1ex,parsep=1ex,label=\textit{Task \Roman*.},align=left,leftmargin=0.5in]
    \item\textit{First task.}
        \begin{enumerate}[topsep=0pt,itemsep=-0.5ex,partopsep=1ex,parsep=1ex,label=(\arabic*)]
            \item Details.
        \end{enumerate}
    \item\textit{Second task.}
        \begin{enumerate}[topsep=0pt,itemsep=-0.5ex,partopsep=1ex,parsep=1ex,label=(\arabic*)]
            \item Details.
        \end{enumerate}
\end{enumerate}
...
\noindent\textit{Through this Workscope, we will \ldots.}

\subsection*{Workscope 2 - Title}
\begin{enumerate}[resume,topsep=0pt,itemsep=0ex,partopsep=1ex,parsep=1ex,label=\textit{Task \Roman*.},align=left,leftmargin=0.5in]
    \item\textit{Next task.}
        \begin{enumerate}[topsep=0pt,itemsep=-0.5ex,partopsep=1ex,parsep=1ex,label=(\arabic*)]
            \item Details.
        \end{enumerate}
    \item\textit{Next task.}
...
\section*{Logical Path to Work Accomplishment. Major Deliverables and Outcomes.} 
The following outcomes are anticipated - 
\begin{enumerate}[leftmargin=*,topsep=0pt,itemsep=-0.75ex,partopsep=1ex,parsep=1ex,label=(\arabic*)]
    \item
    \item
    \item

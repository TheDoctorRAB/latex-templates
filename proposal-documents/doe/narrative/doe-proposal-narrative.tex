...
\paragraph*{Workscope N. Conclusions.} \textit{Full team}
\begin{enumerate}[resume*,topsep=0pt,itemsep=-0.5ex,partopsep=1ex,parsep=1ex,label=\textit{Task \Roman*.},align=left,leftmargin=0.5in]
    \item\textit{Crosscutting issues.}
    \item[]Lessons learned will be identified for project outcomes. Selected additional discussion will cover, but not limited to, the following -

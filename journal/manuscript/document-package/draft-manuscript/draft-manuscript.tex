...
\newcommand{\blc}{\cellcolor{aliceblue}} %use to shade in table cell
\newcommand{\grc}{\cellcolor{lightgray}} %use to shade in table cell
\newcommand{\whc}{\cellcolor{antiquewhite}} %use to shade in table cell
%%%%%

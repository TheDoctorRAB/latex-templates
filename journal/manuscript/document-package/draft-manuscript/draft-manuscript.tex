...
\usepackage[pagewise]{lineno} %line numbering restart
%\usepackage[running]{lineno} %line numbering continuous
\usepackage{setspace}
...
%%%%% watermark
\usepackage[firstpage,vpos=0.73\paperheight]{draftwatermark}
...
\newcommandx{\icr}[2][1=]{\todo[author=\textbf{\acs{icr}},tickmarkheight=0.25cm,backgroundcolor=blue!25,bordercolor=black,#1]{#2}}
...
\makeatletter
    ...
    \newcommand{\hli}[2]{#1}
    \else
    \newcommand{\hli}[2]{\icr[noline]{#2}\hld{#1}}
    \fi
    \makeatother
...
%lhead{\scriptsize}
%\chead{\scriptsize}
\lfoot{\scriptsize Author et al. -- Group\\\textit{Draft Manuscript -- Subject}}
\rfoot{\thepage}
%%%%%
